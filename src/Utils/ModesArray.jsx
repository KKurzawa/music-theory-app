...
const harmonicMinorChordTones = melodicMinorChordTones.map(tone => tone === '6' ? 'b6' : tone)
...
const aeolianChordTones = dorianChordTones.map(tone => tone === '6' ? 'b6' : tone)

const cPhrygian = cAeolian.map(note => note === 'D' ? 'Db' : note)
const phrygianChordTones = aeolianChordTones.map(tone => tone === '2' ? 'b2' : tone)
...
const lydianDominantChordTones = mixolydianChordTones.map(tone => tone === '4' ? '#4' : tone)
